...
void MakeSiFit(int Run, int Seg)
{
	...
	std::string infile = Form("/direct/sphenix+tg+tg01/hf/zshi/MVTXFinalStudyTight/DST/DSTACTSFitted_NoClean_Vertex_%d_%d.root",Run,Seg);
	...
	Fun4AllOutputManager *out = new Fun4AllDstOutputManager("out", "DSTSiFit.root");
