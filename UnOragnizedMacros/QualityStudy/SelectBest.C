...
void SelectBest(int Type){
	...
	TString infile = Form("Files/%s.root",Name.Data());
	...
	TString outfile = Form("SiCut/%s.root",Name.Data());
	...
	TFile * SaveHis = new TFile("SaveHis.root","RECREATE");
	SaveHis->cd();
...
*/
		...
		c->SaveAs(Form("SelPlot/ReuseSiSeed_%d.png",q));
		...
		c->SaveAs(Form("SelPlot/Match/DeltaX_%d.png",q));
		...
		c->SaveAs(Form("SelPlot/Match/DeltaY_%d.png",q));
		...
		c->SaveAs(Form("SelPlot/Match/DeltaZ_%d.png",q));
		...
		NTracks->Draw("epSAME");
		leg2->Draw("epSAME");
		c->SaveAs(Form("SelPlot/Match/NTrack_%d.png",q));
