                                              ...
                                              bool use_intt)
{
  ...
  std::cout << "I am Fitting clusters bro - OK" << std::endl;
  ...
  std::cout << "Am use_intt? It must = " << use_intt << std::endl;
  if(use_intt)
    {
  ...
  std::cout << "std::get<0>(circle_fit_pars) = " << std::get<0>(circle_fit_pars) << "     std::get<1>(circle_fit_pars) = " << std::get<1>(circle_fit_pars) << "     std::get<2>(circle_fit_pars) = " << std::get<2>(circle_fit_pars)  << "     std::get<0>(line_fit_pars) = " << std::get<0>(line_fit_pars)  << "     std::get<1>(line_fit_pars) = " << std::get<1>(line_fit_pars) << std::endl;
