...
void Simple()
{
  std::cout << "Using New Bro" << std::endl;

  std::string infile = "/direct/sphenix+tg+tg01/hf/zshi/MVTXFinalStudy/DST/DSTACTSFitted_NoClean_Vertex_53285_30.root";

  //std::string infilelist = "Infile.txt";
  int runnumber = 53285;
