...
mv  DSTACTSFitted_NoClean_Vertex.root /direct/sphenix+tg+tg01/hf/zshi/MVTXFinalStudy/DST/DSTACTSFitted_NoClean_Vertex_${Run}_${Seg}.root
mv  SeedAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/MVTXFinalStudy/Ntuple/SeedAna_Svtx_${Run}_${Seg}.root
mv  EvtAna_Svtx.root  /direct/sphenix+tg+tg01/hf/zshi/MVTXFinalStudy/EventFile/EvtAna_Svtx_${Run}_${Seg}.root
